...
export class CoupleComponent {
  bride: Person = {
    ...
    bio: 'Princess is a passionate architect who finds beauty in both design and life. She loves traveling, painting, and spending weekends exploring new coffee shops with Michael. Her warm heart and creative spirit light up every room she enters.',
    facts: [
      { icon: 'bi-briefcase', label: 'Profession', value: 'Architect' },
