...
// Modal state
  ...
  weddingHelpers: WeddingHelper[] = [
    // Little Grooms
    {
      ...
      message: 'I get to wear a suit just like Uncle JL! I promise to be super serious and not run.',
      funFact: 'Can recite all the dinosaur names and wants to be a paleontologist.',
      shortMessage: 'So excited to be just like Uncle JL',
      featured: true,
      order: 1
    },
    ...
    // Bearer Team
    {
      ...
      role: 'Ring Bearer',
      category: 'bearer',
      photo: 'assets/images/helpers/ethan.jpg',
      age: 8,
      relationship: 'Cousin',
    ...
    },
    {
      ...
      role: 'Flower Girl',
      category: 'flowerGirl',
      photo: 'https://res.cloudinary.com/ddds8zwgx/image/upload/v1759791546/amaris_tttcju.jpg',
      age: 6,
      relationship: 'Bride\'s Niece',
